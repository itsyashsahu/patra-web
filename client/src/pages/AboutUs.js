                ...
                <div class="about-section-wrapper">
                    ...
                    <Fade left>
                        <div className="about-section-img-box">
                            ...
                            {
                            showDetails?<div className= "about-email" >
                                            <i class="ri-mail-fill"></i>
                                                &nbsp;itsyashsahu@gmail.com
                                            </div>:""
                            }
                            {
                            showDetailsPhone?<div className= "about-email numberFont" >
                                                <i class="ri-phone-fill"></i>
                                                &nbsp;+91 8358991297
                                            </div>:""
                            }
                    ...
                    <div class="about-section-description">
                        ...
                        <div>
                            ...
                            <span>
                                ...
                                Indian Institute of Informational Technology Design & Manufacturing, Jabalpur.  <br/>
                            </span>
                            <span>
                                Do reach out if you feel like my skills could come handy for your prestigious organization.
                            </span>
                        </div>

                        <div>
                            <span className='about-tech-heading'>
                                    Technology Stack Used in This Project
                            </span>
                            <span className="techStack-used">
                                <div>
