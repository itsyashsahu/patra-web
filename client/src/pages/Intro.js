        ...
        <section className="intro-section">
            <div className="intro-section-wrapper">
                ...
                <div class="aboutNfeedback-NavMobile-section">
                    ...
                    <div style={{width:"4rem",marginBottom:"0.5rem"}}>
                        <a href="https://github.com/itsyashsahu/patra-heroku" className="relative p-1 rounded-full text-white focus:outline-none hover:text-red-800 "> 
